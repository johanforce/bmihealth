...
class ListStringTimeDisplay(hoursValue: Int, minValue: Int, context: Context) {
    var hoursValue: String? = null
    var unitHours: String? = null
    var minValue: String
    var minUnit: String? = null

    init {
        if (hoursValue <= 0) {
            this.hoursValue = ""
            unitHours = ""
            minUnit = context.getString(R.string.all_min)
        } else {
            this.hoursValue = hoursValue.toString()
            unitHours = "h"
            minUnit = "m"
        }
