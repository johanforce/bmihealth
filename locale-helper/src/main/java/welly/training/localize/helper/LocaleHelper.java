...
public class LocaleHelper {
    ...
    public void changeLanguage(final Context context, final LocaleHelperActivityDelegate delegate, final OnLocaleChangeListener listener) {
        ...
        languageCodes.addAll(new LocaleData().keySet());

        final List<String> displayLanguages = new ArrayList<>();
        displayLanguages.addAll(new LocaleData().values());
        ...
        if (languageCodes.indexOf(currLanguageCode) == -1) {
            currLanguageCode = "en";
        }
