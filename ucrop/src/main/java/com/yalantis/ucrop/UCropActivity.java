...
public class UCropActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        if (menuItemCropIcon != null) {
            ...
            menuItemCropIcon.setColorFilter(getResources().getColor(R.color.ink_5), PorterDuff.Mode.SRC_ATOP);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, R.color.pri_1));
    ...
    private void setupAppBar() {
        ...
        toolbar.setBackgroundColor(getResources().getColor(R.color.bg_01));
        toolbar.setTitleTextColor(getResources().getColor(R.color.ink_5));
...
//        stateButtonDrawable.setColorFilter(mToolbarWidgetColor, PorterDuff.Mode.SRC_ATOP);
        ...
        actionBar.setTitle(R.string.ucrop_label_edit_photo);
//        if (actionBar != null) {
